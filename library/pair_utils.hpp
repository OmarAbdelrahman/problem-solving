...
template<class U, class V, class T> inline void operator+=(std::pair<U, V>& v, const T x) { v.first += x, v.second += x; }
template<class U, class V, class T> inline void operator-=(std::pair<U, V>& v, const T x) { v.first -= x, v.second -= x; }
template<class U, class V, class T> inline void operator*=(std::pair<U, V>& v, const T x) { v.first *= x, v.second *= x; }
template<class U, class V, class T> inline void operator/=(std::pair<U, V>& v, const T x) { v.first /= x, v.second /= x; }
...
template<class U, class V, class A, class B> inline void operator+=(std::pair<U, V>& l, const std::pair<A, B>& r) {
...
template<class U, class V> inline std::tuple<U, V> as_tuple(const std::pair<U, V>& p) { return {p.first, p.second}; }
template<class U, class V> inline std::pair<U, V> from_tuple(const std::tuple<U, V>& t) { return {std::get<0>(t), std::get<1>(t)}; }
